...
@section('content')
	<div class="container">
		...
		<div class="col-md-8 col-lg-9 col-xl-10">
			@foreach($vendorproducts as $vendorproducts)
			<div class="col-sm-6">
				<a href="{{asset('')}}showcart/{{$vendorproducts->id}}" postID={{$vendorproducts->id}} class="banner banner--md link-img-hover">
				<span class="figure">
					<img src="{{asset('') }}/storage/{{$vendorproducts->thumbnail}}" style="height: 350px; width: 350px" alt="" class="vis-hid-img-small" /> 
					<img src="{{asset('') }}/storage/{{$vendorproducts->thumbnail}}" alt="" class="vis-hid-img-big" />
