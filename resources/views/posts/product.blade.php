							...
							<div class="row">
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 hidden-xs">
									<div class="product-main-image">
										<div class="product-main-image__item"><img class="product-zoom" src='{{asset('shop_asset/images/product/product-big-1.jpg') }}' data-zoom-image="images/product/product-big-1-zoom.jpg" alt="" /></div>
										<div class="product-main-image__zoom"></div>
									</div>
									<div class="product-images-carousel">
										<ul id="smallGallery">
											<li><a href="#" data-image="images/product/product-big-1.jpg" data-zoom-image="images/product/product-big-1-zoom.jpg"><img src="{{asset('shop_asset/images/product/product-small-1.jpg') }}" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-2.jpg" data-zoom-image="images/product/product-big-2-zoom.jpg"><img src="{{asset('shop_asset/images/product/product-small-2.jpg') }}" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-3.jpg" data-zoom-image="images/product/product-big-3-zoom.jpg"><img src="{{asset('shop_asset/images/product/product-small-3.jpg') }}" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-4.jpg" data-zoom-image="images/product/product-big-4-zoom.jpg"><img src="{{asset('shop_asset/images/product/product-small-4.jpg') }}" alt="" /></a></li>
											<li><a href="#" data-image="images/product/product-big-5.jpg" data-zoom-image="images/product/product-big-5-zoom.jpg"><img src="{{asset('shop_asset/images/product/product-small-5.jpg') }}" alt="" /></a></li>
										</ul>
									</div>
								...
								<div class="product-info col-sm-6 col-md-6 col-lg-6 col-xl-6">
									...
									<div class="product-info__description hidden-xs">
										<div class="product-info__description__brand"><img src="{{asset('shop_asset/images/product/product-small-3.jpg') }}images/custom/brand.png"  alt="" /> </div>
